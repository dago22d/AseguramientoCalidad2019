...
function guardar_historial($id_producto,$user_id,$nota,$reference,$quantity){
	global $con;
	$sql="INSERT INTO historial (id_historial, id_producto, user_id, nota, referencia, cantidad,fecha)
	VALUES (NULL, '$id_producto', '$user_id', '$nota', '$reference', '$quantity',now());";
